...
export class ProjectService {
  ...
  */
  ...
  setProjectsSubject(projects: Project[]) {
    console.log('Entering ProjectsService.setProjectsSubject() with size '
      + projects.length);
    this._projectData.next(projects); }
  ...
  getProject(id: number): Promise<Project> {
    ...
    console.log('Entering ProjectsService.getProject() with url ' + url);
